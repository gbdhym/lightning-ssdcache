...
public class DataNode extends Configured 
  ...
  public static InetSocketAddress createSocketAddr(String target) {
    return DFSInputStream.getAdress(target);
  }
  ...
  private void initIpcServer(Configuration conf) throws IOException {
    InetSocketAddress ipcAddr = DFSInputStream.getAdress(
 ...
 */
  ...
  public static InetSocketAddress getInfoAddr(Configuration conf) {
    return DFSInputStream.getAdress(conf.get(DFS_DATANODE_HTTP_ADDRESS_KEY,
  ...
  public static InterDatanodeProtocol createInterDataNodeProtocolProxy(
    ...
    final InetSocketAddress addr = DFSInputStream.getAdress(dnAddr);
  ...
  private class DataTransfer implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        InetSocketAddress curTarget = DFSInputStream.getAdress(dnAddr);
        if (LOG.isDebugEnabled()) {
...
//    conf.set(DFS_DATANODE_DATA_DIR_KEY, locations1);
  ...
  static InetSocketAddress getStreamingAddr(Configuration conf) {
    return DFSInputStream.getAdress(
